...
case class AuthorGithubUsername(value:String) extends Tag(value, "bitbar.author.github")
...
case class Dependencies(values:String*) extends Tag(values.mkString(","), "bitbar.dependencies")
...
case object HideRunInTerminal extends Tag("true", "swiftbar.hideRunInTerminal")
case object HideLastUpdated extends Tag("true", "swiftbar.hideLastUpdated")
case object HideDisablePlugin extends Tag("true", "swiftbar.hideDisablePlugin")
